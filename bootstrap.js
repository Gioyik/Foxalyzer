...
XPCOMUtils.defineLazyGetter(this, "toolStrings", () =>
  Services.strings.createBundle("chrome://csp-validator/locale/strings.properties"));
...
XPCOMUtils.defineLazyGetter(this, "toolDefinition", () => ({
  ...
  key: toolStrings.GetStringFromName("CSP.commandkey"),
  ...
  tooltip: toolStrings.GetStringFromName("CSP.tooltip"),
